"""
保存されたモデルを使用して予測を実行するスクリプト（2x2用）
モデル: GATModel_20250126_173116_Final.pth
入力: 2x2正規化済みDSPSSデータ（引き算→正規化済み）
"""
...
def main():
    parser = argparse.ArgumentParser(description='保存されたモデルで予測を実行（2x2用）')
    ...
    parser.add_argument('--input_data_folder', type=str, 
                       default='/home/nishioka/GNN/GNN_hole_2026/Defect_hole_2x2_Region1_21_npy_subtracted_normalized',
                       help='予測するデータフォルダのパス（2x2正規化済みDSPSSデータ）')
    ...
    parser.add_argument('--label_dir', type=str, 
                       default='/home/nishioka/GNN/GNN_hole_2026/Def2x2_19class_label',
                       help='可視化用のラベルファイルディレクトリ（2x2用）')
    parser.add_argument('--dpsss_dir', type=str,
                       default='/home/nishioka/GNN/GNN_hole_2026/Defect_hole_2x2_Region1_21_npy_subtracted_normalized',
                       help='可視化用のDSPSSデータディレクトリ（2x2用）')
    ...
    if args.output_folder is None:
        ...
        args.output_folder = f"/home/nishioka/GNN/GNN_hole_2026/Predict_data/Predict1_2x2_{input_folder_name}_{timestamp}"
