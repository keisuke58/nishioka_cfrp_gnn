...
# ログファイル名
LOG_FILE="/home/nishioka/GNN/GNN_hole_2026/GNN_program/training_log_minority_large_${TIMESTAMP}.log"
...
echo "Starting minority sampler training (large) at $(date)"
...
echo "PID: ${PID}" > "/home/nishioka/GNN/GNN_hole_2026/GNN_program/training_pid_minority_large_${TIMESTAMP}.txt"
