...
def main(args):
    ...
    for train_index, val_index in kf.split(pairs):
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if rank == 0:
                ...
                plot_confusion_matrix(cm, class_names=[str(i) for i in range(18)])
    ...
    if rank == 0:
        ...
        model_path = f"/home/nishioka/GNN/GNNmodel/18classmodel/{type(model).__name__}_{timestamp}best_model_fold_{all_fold_metrics[0]['fold']}.pth"
